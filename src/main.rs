...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/api/v1/internal/portfolio-sync", post(handlers::portfolio_sync_handler::portfolio_sync_internal))
        ...
        .route("/api/v1/loyalty/referrals", get(handlers::loyalty_v2::get_referrals))
        .route("/api/v1/loyalty/referrals/create", post(handlers::loyalty_v2::account_create_referral))
        .route("/api/v1/loyalty/rewards", get(handlers::loyalty_v2::get_rewards))
        .route("/api/v1/loyalty/vouchers", get(handlers::loyalty_v2::get_vouchers))
        ...
        .route("/api/v1/loyalty/purchase/verify", post(handlers::loyalty_v2::purchase_verify))
        ...
        .route("/api/v1/loyalty/badge/member/:contact_id", get(handlers::loyalty_badges::get_member_badge))
        .route("/api/v1/loyalty/badges/program/:program_slug", get(handlers::loyalty_badges::get_program_badges))
        // Loyalty Enrollment endpoints (Phase 2)
        .route("/api/v1/loyalty/enroll", post(handlers::loyalty_badges::enroll_entity))
        .route("/api/v1/loyalty/unenroll", post(handlers::loyalty_badges::unenroll_entity))
        // Loyalty QR endpoints (Phase 3)
        .route("/api/v1/loyalty/member/:member_id/qr", get(handlers::loyalty_badges::get_member_qr))
        .route("/api/v1/loyalty/member/:member_id/qr/regenerate", post(handlers::loyalty_badges::regenerate_member_qr))
        // Loyalty Scan endpoints (Phase 4)
        .route("/api/v1/loyalty/scan", post(handlers::loyalty_badges::scan_member))
        .route("/api/v1/loyalty/scans/member/:member_id", get(handlers::loyalty_badges::get_member_scans))
        .route("/api/v1/loyalty/scans/business/:business_id", get(handlers::loyalty_badges::get_business_scans))
        // Loyalty Dashboard endpoints (Phase 5)
        .route("/api/v1/loyalty/dashboard/member/:member_id", get(handlers::loyalty_badges::member_dashboard))
        .route("/api/v1/loyalty/dashboard/admin/:program_slug", get(handlers::loyalty_badges::admin_dashboard))
        // Integration Center — API Key management (Phase 6)
        .route("/api/v1/integration/keys", post(handlers::loyalty_badges::create_integration_key))
        .route("/api/v1/integration/keys/:owner_type/:owner_id", get(handlers::loyalty_badges::list_integration_keys))
        .route("/api/v1/integration/keys/:key_id", delete(handlers::loyalty_badges::revoke_integration_key))
        .route("/api/v1/integration/services", get(handlers::loyalty_badges::list_available_services))
        ...
        .route("/api/v1/admin/offers", get(handlers::offers_handler::list_offers).post(handlers::offers_handler::create_offer))
        .route("/api/v1/admin/offers/:id", get(handlers::offers_handler::get_offer).put(handlers::offers_handler::update_offer).delete(handlers::offers_handler::delete_offer))
        ...
        .route("/api/v1/me/usage", get(crate::handlers::auth_handler::get_usage))
